    ...
    case 2:
      {
        ...
        Perl_croak(aTHX_ "arg10 is not of type Qt::Sql::QSqlRecord");
...
PPCODE:
    arg00 = (int)SvIV(ST(1));
    if (sv_isa(ST(2), "Qt::Sql::QSqlField")) {
        arg01 = reinterpret_cast<QSqlField *>(SvIV((SV*)SvRV(ST(2))));
    }
    else
        Perl_croak(aTHX_ "arg01 is not of type Qt::Sql::QSqlField");
...
PPCODE:
    if (sv_isa(ST(1), "Qt::Sql::QSqlRecord")) {
        ...
        Perl_croak(aTHX_ "arg00 is not of type Qt::Sql::QSqlRecord");
